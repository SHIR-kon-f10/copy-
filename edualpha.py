...
Titles = ['Math']*7
Authors = ['Олег Ефимов','Мирон Провоторов',"Алексей Куликов", "Владимир Войков", "Имя Автора", "Имя Автора", "Имя Автора", "Имя Автора", "Имя Автора", "Имя Автора", "Имя Автора", "Имя Автора", "Имя Автора", "Имя Автора", "Имя Автора", "Имя Автора", "Имя Автора", "Имя Автора", "Имя Автора", "Имя Автора", "Имя Автора", "Имя Автора"]
MainTexts = ['Здравствуйте! Меня зовут Олег. Ищу человека для подготовки к МОШу (делать конспекты и таблицы). Help! ','','','','','','','','','','','','','','','','','','','','',]
Tags = ['vanilla']*105
Whens = ['4th Mr']*21
Subjects = ['Maths']*21
